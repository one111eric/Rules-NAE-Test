...
Scenario Outline: Basic end to end to verify new rule works 
	...
	Examples: 
		...
		|424242qa|424242qa|10|miaoSession1|1|
...
Scenario Outline: test how different delays and session names affect results
	...
	Examples: 
		...
		|424242qa|424242qa|10|miaoSession2|5|miaoSession2|1|
		|424242qa|424242qa|10|miaoSession3|5|miaoSession4|2|
		|424242qa|424242qa|10|miaoSession5|11|miaoSession5|2|
